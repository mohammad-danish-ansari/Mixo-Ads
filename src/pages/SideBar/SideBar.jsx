...
const Sidebar = ({ isOpen, onToggle }) => {
  ...
  const menuItems = [
    ...
    { icon: Megaphone, label: 'Campaigns', path: '/Campaigns', active: location.pathname === '/Campaigns' },
    { icon: BarChart3, label: 'Insights', path: '/insights', active: location.pathname === '/insights' },
  ];
        ...
        <div className="p-4 border-b border-gray-200">
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center cursor-pointer" onClick={() => navigate('/')}>
              ...
              {isOpen && (
                <span className="ml-3 text-xl font-semibold text-gray-900">MIXO Ads</span>
              )}
            </div>
            <button
              onClick={onToggle}
